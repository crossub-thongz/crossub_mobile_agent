      ...
      <div className={cn('border-border/40 border-b', shell ? 'px-4 py-4' : 'p-4')}>
        ...
        {metrics ? (
          <div className="mt-4 grid grid-cols-2 gap-2">
            ...
            <PreviewMetric label="Arrears" value={metrics.arrearsLabel} tone={metrics.rentStatusTone} frosted={shell} />
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <section className="space-y-4">
          {(shell ? activeTab === 'overview' : true) ? (
            <>
              <div>
                <h3 className="mb-2 text-sm font-semibold">Tenancy details</h3>
            ...
            <div className="space-y-4">
              {metrics ? (
                <div className="grid grid-cols-2 gap-2">
                  <PreviewMetric label="Rent" value={metrics.rentLabel} />
                  <PreviewMetric label="Lease expiry" value={metrics.leaseExpiryLabel} />
                  <PreviewMetric label="Arrears" value={metrics.arrearsLabel} tone={metrics.rentStatusTone} />
                  <PreviewMetric label="Bond" value={metrics.bondLabel} />
                </div>
              ) : null}
              <Link
