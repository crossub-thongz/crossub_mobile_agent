 ...
 * that the work is acceptable. Agent-facing copy is "Pending approval from CROSSUB"
...
export const AGENT_AWAITING_CROSSUB_APPROVAL_LABEL = 'Pending approval from CROSSUB';
