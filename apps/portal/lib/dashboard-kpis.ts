...
export function buildDashboardKpis(input: {
  ...
  return {
    ...
    leasing: {
      ...
      rentReviewHref: `${ROUTES.TASKS}?filter=Leasing`,
      newLeasingHref: `${ROUTES.TASKS}?filter=Leasing`,
      leaseRenewalHref: `${ROUTES.TASKS}?filter=Leasing`,
      completedHref: `${ROUTES.TASKS}?filter=Leasing`,
    },
    maintenance: {
      ...
      inProgressHref: `${ROUTES.TASKS}?filter=Maintenance`,
      completedHref: `${ROUTES.TASKS}?filter=Maintenance`,
      approvalHref: `${ROUTES.TASKS}?filter=Maintenance`,
    },
    inspection: {
      ...
      openHref: `${ROUTES.TASKS}?filter=Inspection`,
      ingoingHref: `${ROUTES.TASKS}?filter=Inspection`,
      outgoingHref: `${ROUTES.TASKS}?filter=Inspection`,
      routineHref: `${ROUTES.TASKS}?filter=Inspection`,
    ...
    tribunal: {
      ...
      activeHref: `${ROUTES.TASKS}?filter=Tribunal`,
      closedHref: `${ROUTES.TASKS}?filter=Tribunal`,
      actionHref: `${ROUTES.TASKS}?filter=Tribunal`,
    },
  };
}
