...
export const MAINTENANCE: MaintenanceRequest[] = [
  {
    ...
    status: 'Need Quotation Approval',
    priority: 'urgent',
...
export const INSPECTIONS: Inspection[] = [
  ...
  },
  {
    ...
    reportUrl: '#report-insp-open-prop1',
    visitorCount: 18,
    ...
    timeline: [
      {
        id: 't1',
        at: '2024-07-16T09:00:00',
        actor: 'CROSSUB Leasing',
        actorRole: 'crossub',
        title: 'Open report sent to agent',
        source: 'system',
      },
    ],
  },
...
export const DOCUMENTS: AgentDocument[] = [
  ...
  },
  {
    ...
    href: '/inspections/insp-open-prop1',
    downloadUrl: '#report-insp-open-prop1',
  },
  {
    id: 'doc-5',
    ...
    rentIncomeHistory: [
      {
        ...
        paidDate: '2026-06-02',
        amount: 2880,
        description: 'Monthly rent — Jun 2026',
        status: 'paid',
      },
      {
        id: 'ri-1-2',
      ...
      },
      {
        ...
        paidDate: '2026-04-03',
        amount: 2880,
        description: 'Monthly rent — Apr 2026',
        status: 'paid',
      },
      {
        id: 'ri-1-4',
        ...
        paidDate: '2026-03-01',
        amount: 2880,
        description: 'Monthly rent — Mar 2026',
        status: 'paid',
      },
    ],
    bills: [
  ...
  },
  {
    ...
    rentIncomeHistory: [
      ...
      },
      {
        ...
        dueDate: '2026-05-22',
        amount: 650,
        description: 'Weekly rent — partial balance',
        status: 'outstanding',
      },
    ],
    bills: [
